 ...
 * @ingroup Skins
 */
class SkinAIC extends SkinTemplate {

	protected static $bodyClasses = array( 'vector-animateLayout' );

	var $skinname = 'aic', $stylename = 'aic',
		$template = 'AICTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModuleScripts( 'skins.aic' );
		...
		$out->addStyle('aic/screen.css', 'screen');
	}
 ...
 * @ingroup Skins
 */
class AICTemplate extends BaseTemplate {
...
?>
		...
		<div id="mw-head" class="noprint">
			...
			<h1 id="aic-title"><a href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] ) ?>">The <strong>Austin Improv</strong> Wiki</a></h1>
		...
		<!-- panel -->
			<div id="mw-panel" class="noprint">
				<!-- logo -->
					<div id="p-logo"><a class="aic-logo" href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] ) ?>" <?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'p-logo' ) ) ?>></a></div>
				<!-- /logo -->
